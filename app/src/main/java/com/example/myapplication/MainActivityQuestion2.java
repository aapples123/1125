...
public class MainActivityQuestion2 extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        totalQuestionsTextView.setText("猜猜我是誰");

        loadNewQuestion();


        button = (Button) findViewById(R.id.submitGo);
        button.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view) {
                Intent intent = new Intent();
                intent.setClass(MainActivityQuestion2.this,MainActivity_ZZZero.class);
